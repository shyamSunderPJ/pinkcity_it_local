...
def get_columns():
	return [
		...
		{"fieldname":"block_no", "fieldtype":"Float", "label":"Block No -1st", "width":140},
		{"fieldname":"micron_reading", "fieldtype":"Float", "label":"Micron Reading -1st", "width":140},
		{"fieldname":"micron_reading_2", "fieldtype":"Float", "label":"Micron Reading -2nd", "width":140},
		{"fieldname":"micron_reading_3", "fieldtype":"Float", "label":"Micron Reading -3rd", "width":140},
		{"fieldname":"micron_reading_4", "fieldtype":"Float", "label":"Micron Reading -4th", "width":140},
		{"fieldname":"micron_reading_5", "fieldtype":"Float", "label":"Micron Reading -5th", "width":140},
...
def get_data(filters):
	...
	query = f"""SELECT 
				...
				tpmbd.design_code, 
				tpmbd.block_no ,
				tpmbd.micron_reading ,
				tpmbd.micron_reading_2 ,
				tpmbd.micron_reading_3 ,
				tpmbd.micron_reading_4 ,
				tpmbd.micron_reading_5 ,
